...
def list_characters(dict, dict2):
  for zom in dict:
    print(f"{Colors.purple}{zom}{Colors.reset} is from {Colors.yellow}Game {dict[zom]['Game']}{Colors.reset}, is in the {Colors.red}{dict[zom]['Class']} Class{Colors.reset}, has {Colors.lightcyan}{dict[zom]['Variants']} Variants{Colors.reset} and has {Colors.green}{dict[zom]['Health']} Health.{Colors.reset}")
    print()
  for zom in dict2:
    print(f"{Colors.green}{zom}{Colors.reset} is from {Colors.yellow}Game {dict2[zom]['Game']}{Colors.reset}, is in the {Colors.red}{dict2[zom]['Class']} Class{Colors.reset}, has {Colors.lightcyan}{dict2[zom]['Variants']} Variants{Colors.reset} and has {Colors.green}{dict2[zom]['Health']} Health.{Colors.reset}")
    print()
